...
! function(e, c) {
  ...
  "use strict";
  S = S && S.hasOwnProperty("default") ? S["default"] : S, Object.assign(S.POPUP_TEMPLATES, {
        ...
        return '\n        <div class="fr-icon-container fr-emoticon-container">\n            '.concat(function c(e) {
          ...
          return e.emoticons.forEach(function(e) {
            var c = e.code.split("-").reduce(function(e, c) {
              ...
              d = {
                image: e.code.toLowerCase(),
                compiledCode: e.uCode ? e.uCode : c
              },
              o = {
    ...
    return {
      ...
      showEmoticonsPopup: function l() {
        ...
        if (e || (e = function s() {
            ...
            m.events.on("popup.tab", function(e) {
              ...
              if (S.KEYCODE.TAB == s) {
                ...
                if (c.is("span.fr-emoticon")) {
                  ...
                  o = n.index(c);
                  var t = m.opts.emoticonsStep,
                    l = Math.floor(n.length / t),
                    r = o % t,
                    F = Math.floor(o / t),
                    g = F * t + r,
                    u = l * t;
          ...
          var c = m.$tb.find('.fr-command[data-cmd="emoticons"]'),
            d = m.button.getPosition(c),
            o = d.left,
            a = d.top;
  ...
  S = S && S.hasOwnProperty("default") ? S["default"] : S, Object.assign(S.POPUP_TEMPLATES, {
    ...
    function n() {
      return "".concat(function o(e, c) {
        return '<div class="fr-buttons fr-tabs fr-tabs-scroll">\n                        '.concat(function d(e, o) {
          var a = "";
          a += '<div class="toggle_background" style="background-color: #222222; height:30px;vertical-align:middle;display: flex; align-items: center"><select class="tab-toggle" style="background-color: #222222; font-size: 12px; padding-left: 10px;">' +
            '<option value="emoji">Emoji 13.0</option>' +
            '<option value="froala">Emoji One</option>' +
            '</select></div>'
          a += '<div>'
          ...
          return e.forEach(function(e) {
            ...
            a += `<button class="fr-command fr-btn ${d.elementClass} ${d.emoticonsUnicodeClass} fet fet-${e.id}" style="font-size: 26px" title="${d.title}" data-cmd="${d.dataCmd}" data-param1="${d.dataParam1}"></button>`
            
          }), a
        }(e, c), "\n                        </div>")
      }(a, s), "\n                      ").concat(function d(e) {
        return '\n       </div><div class="fr-icon-container fr-emoticon-container">\n            '.concat(function c(e) {
          var a = "";
          return e.emoticons.forEach(function(e) {
            var c = e.code.split("-").reduce(function(e, c) {
                return e ? "".concat(e, "&zwj;&#x").concat(c.toLowerCase(), ";") : "&#x".concat(c.toLowerCase(), ";")
