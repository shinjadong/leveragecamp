        ...
        <div className="border-t p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">admin@leveragecamp.com</p>
            </div>
          </div>
          <Link
            href="/"
            className="mt-4 flex w-full items-center gap-2 rounded-md bg-gray-100 px-3 py-2 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
        ...
        <header className="sticky top-0 z-40 flex h-16 items-center border-b bg-white px-6">
          ...
          <div className="ml-4 lg:ml-0">
            <h1 className="text-lg font-medium">
              {menuItems.find((item) => item.href === pathname)?.title || "관리자 페이지"}
            </h1>
          </div>
